...
const formSchema = z.object({
  ...
  colorId: z.string().min(1, { message: "El color es requerido." }),
  sizeId: z.string().min(1, { message: "El tamaño es requerido." }),
...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const description = initialData
    ? "Editar Producto"
    : "Crear Producto Para Mostrar en la Tienda";
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue
                          defaultValue={field.value}
                          placeholder="Selecciona una Publicidad"
                        />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Este producto se mostrara en la tienda.
                    </FormDescription>
                  </div>
                </FormItem>
              )}
